			...
			<div class="email-tem-inn">
				<div class="email-tem-main">
					<div class="email-tem-head">
						<h2><img src="images/mail/letter.png" alt=""> You have Subscribe our trending updates</h2>
					</div>
					<div class="email-tem-body">
						...
						<div class="email-point">
							<div class="email-point-left">
								<img src="images/mail/store.png" alt="">
							</div>
							<div class="email-point-righ">
								<h4>Porofile completion 80%</h4>
								<p>looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through</p>
							</div>							
						</div>
						<div class="email-point">
							<div class="email-point-left">
								<img src="images/mail/employee.png" alt="">
							</div>
							<div class="email-point-righ">
