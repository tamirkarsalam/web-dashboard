			...
			<div class="email-tem-inn">
				<div class="email-tem-main">
					<div class="email-tem-head">
						<h2><img src="images/mail/letter.png" alt=""> You have successfully registered</h2>
					</div>
					<div class="email-tem-body">
						...
						<div class="email-list">
							<ul>
								<li><b>User Name</b>: rn53themes</li>
								<li><b>Password</b>: password@123</li>
							</ul>
						</div>
						<a href="#">Verify and confirm</a>
					</div>
				</div>
